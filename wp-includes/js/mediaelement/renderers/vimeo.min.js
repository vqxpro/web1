...
! function a(o, s, u) {
    ...
    1: [function(e, t, n) {
        ...
        var T = {
                promise: null,
                load: function(e) {
                    "undefined" != typeof Vimeo ? T._createPlayer(e) : (T.promise = T.promise || mejs.Utils.loadScript("https://player.vimeo.com/api/player.js"), T.promise.then(function() {
                        T._createPlayer(e)
                    }))
                },
                ...
                create: function(f, e, t) {
                    ...
                    window["__ready__" + h.id] = function(e) {
                        ...
                        for (var o = document.getElementById(h.id), s = void 0, u = function(e) {
                                ...
                                f.dispatchEvent(t)
                            }, c = 0, l = (s = ["mouseover", "mouseout"]).length; c < l; c++) o.addEventListener(s[c], u, !1);
